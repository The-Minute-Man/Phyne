...
export default function ElectromagnetismModule() {
  ...
  return (
    <main className="container section-padding">
      <ScrollReveal>
        <h1 className="text-display-md">Electricity & Magnetism Module</h1>
      ...
      <div className="grid gap-md" style={{ marginTop: '2rem' }}>
        {emUnits.map((unit, i) => (
          <ScrollReveal key={i} delay={i * 0.1}>
            <div className="glass-panel" style={{ padding: '1.5rem', backgroundColor: unit.course !== 'Electricity & Magnetism' ? 'rgba(255,255,255,0.05)' : 'transparent' }}>
